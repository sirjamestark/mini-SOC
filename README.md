...
6. Alerts are displayed on the dashboard and critical alerts trigger notifications.
...
DNS activity monitoring dashboard.

![DNS Dashboard](screenshots/dns_dashboard.png)

---

## Port Scan Detection

Port scanning detection example.

![Portscan Dashboard](screenshots/portscanning_dashboard.png)

---

## Event Correlation

Example of correlated alerts generated from multiple events.

![Correlation Dashboard](screenshots/correlation_dashboard.png)

---

## Alert Example

Critical alert example generated by the system.
...
Working prototype.  
Future improvements include expanding detection rules, improving correlation logic and adding more threat detection capabilities.
